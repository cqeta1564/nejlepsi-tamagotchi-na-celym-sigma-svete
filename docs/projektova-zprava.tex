...
\placeholderfigure{Volitelny Lighthouse dukaz}{Pro odevzdani lze doplnit screenshot z Chrome DevTools -> Lighthouse -> PWA. Technicka kontrola artefaktu je uz soucasti repozitare pres \texttt{npm run verify:pwa}.}
...
\begin{itemize}[leftmargin=2em]
  \item PWA cast je technicky zapojena a ma automatickou kontrolu artefaktu; realny Lighthouse screenshot lze doplnit jako vizualni doklad z prohlizece.
...
\begin{itemize}[leftmargin=2em]
  \item Dolozit PWA vrstvu volitelnym Lighthouse screenshotem a rucnim testem instalace na plochu.

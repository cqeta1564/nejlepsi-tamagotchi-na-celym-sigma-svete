...
Repozitar obsahuje zakladni jednotkove testy spustitelne prikazem \texttt{npm test}. Testy pouzivaji vestaveny Node.js test runner a samostatny TypeScript build pres \texttt{tsconfig.test.json}, takze neni potreba dalsi testovaci framework.
...
\begin{itemize}[leftmargin=2em]
  \item \texttt{npm test} -- proslo bez chyb,
...
CI workflow na GitHub Actions nove spousti testy, lint a produkcni build pred nahranim vystupu na GitHub Pages. Integracni testy celeho React rozhrani zatim doplnene nejsou, proto zustavaji soucasti overovani i rucni scenare.
...
\begin{itemize}[leftmargin=2em]
  ...
  \item Automaticke testy jsou zatim jen zakladni jednotkove testy herni logiky, takze nepokryvaji cele React rozhrani.
...
\begin{itemize}[leftmargin=2em]
  ...
  \item Rozsirit automaticke testy o zakladni integracni testy hlavnich obrazovek.

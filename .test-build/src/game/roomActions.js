...
export function executeRoomAction(roomId, stats, currentCoins, casinoRoll = Math.random()) {
    ...
    const coinsDelta = casinoRoll > 0.82 ? 35 : casinoRoll > 0.52 ? 10 : casinoRoll > 0.24 ? 0 : -8;
    const nextStats = {
...
export function getMoodFromStats(stats) {
...
export function hasAnyZeroStat(stats) {

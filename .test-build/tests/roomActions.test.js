...
import { ROOM_ACTION_COSTS, clampStat, executeRoomAction, getMoodFromStats, hasAnyZeroStat, } from '../src/game/roomActions.js';
const baseStats = {
    food: 72,
    health: 90,
    happiness: 80,
...
describe('room actions', () => {
    ...
    it('applies the kitchen action and clamps improved stats', () => {
        const result = executeRoomAction('kitchen', { ...baseStats, food: 90, energy: 98 }, 24);
